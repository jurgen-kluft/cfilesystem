...
Build {
	...
	Units = function ()
		...
		local xfilesystem_library = StaticLibrary {
			Name = "xfilesystem",
			Config = "*-*-*-*",
			Sources = { SourceGlob("source/main/cpp") },
			Includes = { "..//xfilesystem/source/main/include","..//xbase/source/main/include","..//xtime/source/main/include" },
		}
		...
		local unittest = Program {
			Name = "xfilesystem_test",
			Config = "*-*-*-test",
			Sources = { SourceGlob("source/test/cpp") },
			Includes = { "source/main/include","source/test/include","..//xunittest/source/main/include","..//xentry/source/main/include","..//xbase/source/main/include","..//xtime/source/main/include","..//xfilesystem/source/main/include" },
			Depends = { xfilesystem_library,xunittest_library,xentry_library,xbase_library,xtime_library },
		}
		Default(unittest)
	end,
	Configs = {
