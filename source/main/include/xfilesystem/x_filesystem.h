...
namespace xcore
{
    ...
    public:
        ...
        static bool register_device(const utf32::crunes& device_name, filedevice_t*);

        static filepath_t filepath(const char* str);
        static dirpath_t  dirpath(const char* str);
        static filepath_t filepath(const utf32::crunes& str);
        static dirpath_t  dirpath(const utf32::crunes& str);
        static void      to_ascii(filepath_t const& fp, ascii::runes& str);
        static void      to_ascii(dirpath_t const& dp, ascii::runes& str);
