...
namespace xcore
{
	...
	namespace xfilesystem
	{
		...
		extern u32				open				( const char* szFilename, xbool boRead = true, xbool boWrite = false, x_asyncio_callback_struct* callback = NULL );
		extern u64				read				( u32 uHandle, u64 uOffset, u64 uSize, void* pBuffer, x_asyncio_callback_struct* callback = NULL );	
		extern u64				write				( u32 uHandle, u64 uOffset, u64 uSize, const void* pBuffer, x_asyncio_callback_struct* callback = NULL );
		extern u64				getpos				( u32 uHandle );
		extern u64				setpos				( u32 uHandle, u64 uPos );
		extern void 			close				( u32& uHandle, x_asyncio_callback_struct* callback = NULL );
		extern void				closeAndDelete		( u32& uHandle, x_asyncio_callback_struct* callback = NULL );
