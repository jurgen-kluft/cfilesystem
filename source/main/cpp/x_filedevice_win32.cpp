...
namespace xcore
{
	...
	bool FileDevice_PC_System::seekOrigin(void* nFileHandle, u64 pos, u64& newPos) const { return seek(nFileHandle, __SEEK_ORIGIN, pos, newPos); }

	bool FileDevice_PC_System::seekCurrent(void* nFileHandle, u64 pos, u64& newPos) const { return seek(nFileHandle, __SEEK_CURRENT, pos, newPos); }

	bool FileDevice_PC_System::seekEnd(void* nFileHandle, u64 pos, u64& newPos) const { return seek(nFileHandle, __SEEK_END, pos, newPos); }
}; // namespace xcore
