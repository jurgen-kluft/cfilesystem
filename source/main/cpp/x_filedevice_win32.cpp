...
namespace xcore
{
    ...
    bool xfiledevice_pc::getDeviceInfo(u64& totalSpace, u64& freeSpace) const
    {
        ...
        xpath drivepath16;
        xpath::as_utf16(mDrivePath, drivepath16);
    ...
    bool xfiledevice_pc::hasFile(const xfilepath& szFilename)
    {
        ...
        xpath filename16;
        xpath::as_utf16(szFilename, filename16);
    ...
    bool xfiledevice_pc::moveFile(const xfilepath& szFilename, const xfilepath& szToFilename, bool boOverwrite)
    {
        ...
        xpath::as_utf16(szFilename, filename16);
        xpath tofilename16;
        xpath::as_utf16(szToFilename, tofilename16);
    ...
    HANDLE xfiledevice_pc::sOpenDir(xdirpath const& szDirPath)
    {
        ...
        xpath path16;
        xpath::as_utf16(szDirPath, path16);
    ...
    {
        xpath filename16;
        xpath::as_utf16(szDirPath, filename16);
    ...
    bool xfiledevice_pc::moveDir(const xdirpath& szDirPath, const xdirpath& szToDirPath, bool boOverwrite)
    {
        ...
        xpath dirpath16;
        xpath::as_utf16(szDirPath, dirpath16);
        xpath todirpath16;
        xpath::as_utf16(szToDirPath, todirpath16);
    ...
    struct xdirwalker
    {
        ...
        bool enter_dir()
        {
            ...
            xpath dirpath16;
            xpath::as_utf16(mDirPath, dirpath16);
