...
namespace xcore
{
	...
	xfiletimes::xfiletimes(const xfiletimes& ftimes) : m_creationtime(ftimes.m_creationtime), m_lastaccesstime(ftimes.m_lastaccesstime), m_lastwritetime(ftimes.m_lastwritetime) {}
